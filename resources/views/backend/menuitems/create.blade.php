                        ...
                        <form action="{{ route('menu-items.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter Menu Item Name" value="{{ old('name') }}" required>
                                </div>

                                <!-- Price -->
                                <div class="form-group col-md-6">
                                    <label for="price">Price</label>
                                    <input type="number" id="price" name="price" class="form-control" placeholder="Enter Price" value="{{ old('price') }}" step="0.01" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="tags" name="tags" class="form-control tokenfield" placeholder="Add Tags for this Food...">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-control" placeholder="Enter a brief description of the food item">{{ old('short_description') }}</textarea>
                            </div>
